...
def init():
    X=0   #these are going to be shown on the y-axis, it is the amount of successes for N trials it is not necessary but it one big block of colour at the bottom
